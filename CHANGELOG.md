Breaking changes are documented using GitHub issues, see [issues labeled "release notes"](https://github.com/hapijs/rule-no-var/issues?q=is%3Aissue+label%3A%22release+notes%22).
